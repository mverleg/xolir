...
The goal of Tel is to generate code in multiple languages. To make this easier, this IR is the intermediate format that Tel generates and that backends consume.
